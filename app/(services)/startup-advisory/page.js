...
export default function Home() {
  const serviceDetails = {
    ...
    serviceDescription2: 'Our team also offers ongoing **startup compliance support**, helping you navigate complex regulations and legal requirements. We assist with everything from initial permits to ongoing corporate governance. By handling these critical legal details, we allow you to focus on innovation and growth, confident that your business is operating legally and securely.',
    benefitTitle: 'Benefits of our services',
    benefitDescription: 'Partnering with us from the outset gives your startup a critical advantage. We help you avoid common legal pitfalls, ensuring your business is structured for success. Our proactive approach saves you time and money by preventing future legal issues, allowing you to build your company on a foundation of legal stability and clarity.',
    benefits: [
    ...
    justiceText1: 'Every great company starts with an idea, and we are here to provide the legal framework to make that idea a reality. We empower entrepreneurs by translating their vision into a legally sound business, providing peace of mind as they embark on their journey. Our support ensures your hard work is protected and poised for success.',
    justiceList: ['From Idea to Incorporated Reality', 'Strategic Legal Foundation for Growth', 'Empowering Entrepreneurs with Legal Clarity'],
    contentImgs3: [
    ...
    faqs: [
      { question: 'What is the most important legal step for a new startup?', answer: 'The most important step is choosing the right legal structure for your business (e.g., LLP, Private Limited Company). This decision impacts liability, taxation, and fundraising ability, and getting it right from the start is crucial for long-term success.' },
      { question: 'Why do we need a Founders\' Agreement?', answer: 'A Founders\' Agreement is essential to define the roles, responsibilities, ownership shares, and decision-making processes among the founders. It prevents future disputes and provides a clear framework for how the company will operate and handle potential disagreements.' },
      { question: 'How long does company registration typically take?', answer: 'The duration of company registration varies depending on the legal structure and jurisdiction. We work to make the process as fast as possible, often completing it within a few business days once all required documents are submitted and verified.' },
    ],
  };

  return (
    <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Startup Advisory & Incorporation">
