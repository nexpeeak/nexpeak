...
export default function ClientPage() {
  const serviceDetails = {
    ...
    serviceList: [
      { name: 'Startup Advisory & Incorporation', link: '/startup-advisory', isActive: true },
      ...
      { name: 'Mergers & Acquisitions (M&A)', link: '/mergers-acquisitions', isActive: false },
    ...
    faqIntro:
      'Answers to common legal questions founders have during the inception phase of their startup.',
    faqs: [
      {
        question: 'What is the most important legal step for a new startup?',
        answer:
          'The most important step is choosing the right legal structure (e.g., LLP, Private Limited Company). This decision impacts liability, taxation, and fundraising ability.',
      },
      {
        question: "Why do we need a Founders' Agreement?",
        answer:
          "It defines roles, responsibilities, ownership shares, and decision-making processes. It prevents future disputes and provides a clear framework for company operations.",
      },
      {
        question: 'How long does company registration typically take?',
        answer:
          'The duration varies depending on the legal structure. We work to make the process as fast as possible, often completing it within a few business days once required documents are verified.',
      },
    ],
  };
