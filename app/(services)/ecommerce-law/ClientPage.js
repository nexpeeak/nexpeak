...
export default function ClientPage() {
  const serviceDetails = {
    ...
    faqs: [
      {
        question: 'What is the most important legal document for an e-commerce site?',
        answer:
          'The Terms of Service (ToS) and Privacy Policy are the most crucial. The ToS sets the rules for using your platform, while the Privacy Policy informs users about how their data is collected, used, and protected, which is essential for compliance with laws like GDPR.',
      },
      {
        question: 'How do I handle international sales and regulations?',
        answer:
          'When selling internationally, you must comply with the consumer and data protection laws of each country you serve. We provide advice on international regulations, including cross-border data transfer laws and specific consumer protection requirements for different regions.',
      },
      {
        question: 'What are the key liability concerns for an e-commerce business?',
        answer:
          'Key concerns include product liability, data breaches, and intellectual property infringement. Our services help you draft contracts and policies that limit your liability and implement best practices to reduce these risks, ensuring you are protected against potential legal challenges.',
      },
    ],
  };
  ...
  return (
    <Layout
      headerStyle={1}
      footerStyle={1}
      breadcrumbTitle="Digital Business & E-Commerce Law"
    >
