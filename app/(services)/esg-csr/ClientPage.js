...
export default function ClientPage() {
  const serviceDetails = {
    ...
    serviceList: [
      ...
      { name: 'Digital Business & E-Commerce Law', link: '/ecommerce-law', isActive: false },
    ...
    faqIntro:
      'Understanding the fundamentals and requirements of ESG and CSR in the modern corporate landscape.',
    faqs: [
      {
        question: 'What is the difference between CSR and ESG?',
        answer:
          'CSR (Corporate Social Responsibility) is a self-regulating business model that helps a company be socially accountable. ESG (Environmental, Social, and Governance) is a set of measurable standards that investors use to screen potential investments.',
      },
      {
        question: 'Why is ESG reporting becoming mandatory?',
        answer:
          "Investors and regulators increasingly recognize that ESG factors are crucial for assessing a company's long-term value and risk. Mandatory reporting ensures transparency and accountability through standardized data.",
      },
      {
        question: 'How can our company get started with ESG compliance?',
        answer:
          'The best first step is to conduct a thorough assessment of your current operations. We can help you identify material ESG risks and opportunities, create a tailored plan, and establish clear metrics for reporting.',
      },
    ],
  };
