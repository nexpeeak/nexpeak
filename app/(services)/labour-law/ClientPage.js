...
export default function ClientPage() {
  const serviceDetails = {
    ...
    faqIntro:
      'Common questions regarding workplace compliance, labour regulations, and employment policies.',
    faqs: [
      {
        question: 'What is a labour audit and why is it important?',
        answer:
          'A **labour audit** is a comprehensive review of a company’s employment practices and records to ensure they comply with all applicable labour laws. It identifies and rectifies non-compliance issues before they result in legal action or fines.',
      },
      {
        question: 'What does POSH compliance entail?',
        answer:
          '**POSH** (Prevention of Sexual Harassment) compliance requires companies to establish a clear policy, form an Internal Complaints Committee (ICC), and conduct regular awareness training for all employees.',
      },
      {
        question: 'Can you help with drafting different types of employee contracts?',
        answer:
          'Yes, we draft various types of employee contracts, including full-time, part-time, fixed-term, and consultancy agreements, tailored to protect your business interests and define clear terms.',
      },
    ],
  };
