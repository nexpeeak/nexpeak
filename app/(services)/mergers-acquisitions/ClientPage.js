...
export default function ClientPage() {
  const serviceDetails = {
    ...
    faqIntro:
      'Common inquiries regarding the legal complexities and processes involved in M&A transactions.',
    faqs: [
      {
        question: 'What is the most critical part of the M&A process?',
        answer:
          'Due diligence is the most critical part. It involves a comprehensive investigation of a target company to identify all legal, financial, and operational risks before the deal is finalized.',
      },
      {
        question: 'What is a Share Purchase Agreement?',
        answer:
          "A **Share Purchase Agreement (SPA)** is a legally binding contract outlining the terms for the sale and purchase of a company's shares, including price, warranties, and indemnities.",
      },
      {
        question: 'How long does a typical M&A transaction take?',
        answer:
          'The duration varies based on complexity and size. Simple deals may take a few months, while complex or cross-border acquisitions can take over a year. We aim to streamline the process as efficiently as possible.',
      },
    ],
  };
