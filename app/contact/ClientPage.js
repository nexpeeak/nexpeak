                    ...
                    <div className="contact-page__top-single">
                      <div className="contact-page__top-single-inner">
                        ...
                        <div className="content-box">
                          <div className="title-box">
                            <div className="line"></div>
                            <div className="text"><p>Email us</p></div>
                          </div>
                          <h2><a href="mailto:nexpeaklawfirm@gmail.com">nexpeaklawfirm@gmail.com</a></h2>
                          <h2><a href="mailto:nexpeaklegal@gmail.com">nexpeaklegal@gmail.com</a></h2>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="contact-page__top-single">
                      <div className="contact-page__top-single-inner">
                        ...
                        <div className="content-box">
                          <div className="title-box">
                            <div className="line"></div>
                            <div className="text"><p>Phone no</p></div>
                          </div>
                          <h2><a href="tel:+919027667840">+91 9027667840</a></h2>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="contact-page__form">
                      <div className="sec-title">
                        <div className="sub-title">
                          ...
                          <div className="text"><p>get in touch</p></div>
                        </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div className="contact-page__input-box">
                              ...
                              <div className="icon-box"><span className="icon-icon-37"></span></div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-xl-6">
                            <div className="contact-page__input-box">
                              ...
                              <div className="icon-box"><span className="icon-icon-23"></span></div>
                            </div>
                          </div>
                        </div>
                            ...
                            <div className="contact-page__btn">
                              ...
                              >
                                {isSubmitting ? (
                                  ...
                                  <>Send Message <span className="thm-btn__icon"><FaPaperPlane /></span></>
                                )}
                              </button>
                            </div>
                          </div>
