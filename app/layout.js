...
export const metadata = {
  ...
  description:
    'Leading legal firm specializing in AI compliance, data protection, IPR, and startup advisory. Expert legal counsel in Gurugram and Delhi for modern enterprises.',
  keywords: [
    'Startup Advisory',
  ...
  openGraph: {
    ...
    description:
      'Specialized legal counsel for Startups, AI, Data Protection, and Corporate Compliance. Trusted advisors in India.',
    url: 'https://www.nexpeaklegal.com/',
    siteName: 'Nexpeak Legal Services',
    images: [
      {
        url: 'https://www.nexpeaklegal.com/images/logo-card.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: 'Nexpeak | Expert Legal & Compliance Services',
    description:
      'Expert legal firm for AI compliance, data protection, IP law, and comprehensive business legal services.',
    images: ['https://www.nexpeaklegal.com/images/logo-card.png'],
  },
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                'Expert legal and compliance services for startups and modern businesses, specializing in Tech Law, IP, and Corporate Governance.',
              address: [
                {
                  '@type': 'PostalAddress',
