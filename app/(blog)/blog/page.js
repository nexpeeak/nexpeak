...
export const blogData = [
    {
      ...
      excerpt: 'Replenish given whose be signs is land itself all isn\'t night favour seasons cattle place day seas sixth wherein wherein void don\'t good you\'re his it sea third let don\'t creature own',
...
export default function Home() {
    return (
        <Layout headerStyle={2} footerStyle={3} breadcrumbTitle="Blog standard">
            <div>
                {/* Start Blog Page */}
