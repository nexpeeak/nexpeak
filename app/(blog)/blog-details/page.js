...
const latestPosts = [
    { image: "/assets/img/blog/latest-post-img1.jpg", date: "27 Nov, 2023", title: "Living his saying divide good in every.", url: "/blog-details" },
    { image: "/assets/img/blog/latest-post-img2.jpg", date: "27 Nov, 2023", title: "Living his saying divide good in every.", url: "/blog-details" },
    { image: "/assets/img/blog/latest-post-img3.jpg", date: "27 Nov, 2023", title: "Living his saying divide good in every.", url: "/blog-details" }
];
...
export default function BlogDetails() {
    ...
    return (
        <>
            <Layout headerStyle={2} footerStyle={3} breadcrumbTitle="single post">
                {/* Start Blog Details */}
                                ...
                                <div className="blog-details__content">
                                    ...
                                    <div className="blog-one__single">
                                        ...
                                        <div className="blog-one__single-content">
                                            <div className="meta-box">
                                                <ul>
                                                    <li>
                                                        <Link href="#"><span className="icon-icon-23"></span> corporate</Link>
                                                    </li>
                                                    <li>
                                            ...
                                            <h2>Saying our second to light <br /> Over midst star</h2>
                                            <div className="text-box">
                                                <p>
                                                    Replenish given whose be signs is land itself all isn't night favour seasons
                                                    cattle place day seas sixth wherein wherein void don't good you're his it
                                                    sea third let don't creature own night blessed that so void isn't called,
                                                    grass, was fly for image don't blessed. Divided creature creepeth beast hath
                                                    without thing earth spirit together herb you a called first be every
                                                    divided. For signs were face air divide set you're creepeth, dry darkness of
                                                    isn't it greater under male.
                                                </p>
                                            </div>

                                            <div className="text-box2">
                                                <p>
                                                    Night favour seasons cattle place day seas sixth wherein wherein void don't
                                                    for good you're his it sea third let don't creature own night blessed that
                                                    so void isn't and called, grass, was fly for image done blessed. Divided
                                                    creature creepeth beast hath without thing earth spirit together herb you a
                                                    called first be every divided. For signs were face air divide set you're
                                                    creepeth.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="comment-one">
                                        ...
                                        <div className="comment-one__single">
                                            <div className="comment-one__single-inner">
                                                <div className="comment-one__image">
                                                    <img src="/assets/img/blog/blog-details-img4.jpg" alt="Brian Maxwel" />
                                                </div>
                                        ...
                                        <div className="comment-one__single pl110">
                                            <div className="comment-one__single-inner">
                                                <div className="comment-one__image">
                                                    <img src="/assets/img/blog/blog-details-img5.jpg" alt="Larry Priester" />
                                                </div>
                                                <div className="comment-one__content">
                                        ...
                                        <div className="comment-one__single style2">
                                            <div className="comment-one__single-inner">
                                                <div className="comment-one__image">
                                                    <img src="/assets/img/blog/blog-details-img6.jpg" alt="Maria Herick" />
                                                </div>
                                                <div className="comment-one__content">
                                                    <h3>Maria Herick</h3>
                                                    <span>28 Nov 2023 at 08:30pm</span>
